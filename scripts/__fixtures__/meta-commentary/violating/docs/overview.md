...
This page is compiled from the canonical source in the docs monorepo and will be
overwritten the next time the sync runs — do not hand-edit it here.

The Example integration connects your Example workspace to Cinatra.

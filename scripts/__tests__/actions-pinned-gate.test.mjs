...
// and its tests run with ZERO install — keeping the CI gate job lean, which
// matters for a supply-chain-hardening gate.
//
// Contract lives in scripts/actions-pinned-gate.mjs:
...
test("live: the actual gate run over .github/workflows exits 0", () => {
  ...
  const gate = resolve(root, "scripts/actions-pinned-gate.mjs");

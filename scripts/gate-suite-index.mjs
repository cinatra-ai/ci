 ...
 *
 * Ratified spec: the Truthful Attribution protocol §4. The per-repo committed
...
export function buildIndex(inventory, reader, now) {
  ...
  return {
    $comment:
      "GENERATED, READ-ONLY org-wide gate-suite audit index (the Truthful Attribution protocol §4). " +
    ...
    auditObligation: {
      ...
      evidence: "closing comment on a recurring `Gate-suite audit YYYY-MM` tracking issue",
